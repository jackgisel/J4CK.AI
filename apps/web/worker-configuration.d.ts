/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1eb3c175a1fe9d20c727d93129934b01)
...
interface __BaseEnv_Env {
	...
	EMAIL: SendEmail;
	AI: Ai;
	EMAIL_FROM: "noreply@j4ck.ai";
	AI_GATEWAY_ID: "j4ck-ai-gate";
	BETTER_AUTH_SECRET: string;
	GuyAgent: DurableObjectNamespace<import("./worker/index").GuyAgent>;
	PipelineRunAgent: DurableObjectNamespace<import("./worker/index").PipelineRunAgent>;
	PIPELINE_WORKFLOW: Workflow<Parameters<import("./worker/index").PipelineWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "GuyAgent" | "PipelineRunAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "AI_GATEWAY_ID" | "BETTER_AUTH_SECRET">> {}
}
