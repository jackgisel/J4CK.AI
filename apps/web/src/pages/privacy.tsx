export function PrivacyPage() {
  return (
    <article className="flex max-w-prose flex-col gap-6 text-sm leading-relaxed">
      ...
      <p className="text-muted-foreground">Last updated August 26, 2026.</p>
      <p>
      ...
      <p>
        ...
        as-is). If you train a guy from a GitHub URL, the Worker fetches that
        repository (using a token you paste, if it is private) and copies skills
        and files into that folder. The token is not stored. Replies are
        generated by Cloudflare Workers AI from the thread, the guy's backstory,
        and that folder.
      </p>
      <h2 className="font-heading text-lg font-semibold tracking-wider uppercase">
        Where it lives
